...
public class InMemoryModuleArtifactsCache extends DefaultModuleArtifactsCache {
    public InMemoryModuleArtifactsCache(BuildCommencedTimeProvider timeProvider, CacheLockingManager cacheLockingManager) {
        super(timeProvider, cacheLockingManager);
    }
    ...
    public CachedArtifacts getCachedArtifacts(ModuleComponentRepository repository, ComponentIdentifier componentId, String context) {
        ...
        return inMemoryEntry == null ? null : createCacheArtifacts(inMemoryEntry);
    }
}
